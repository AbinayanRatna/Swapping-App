...
class AdminViewCategory : AppCompatActivity() {
    ...
    private fun getUserData() {
        ...
        val mAdapter = categoryAdaptor(empList, this@AdminViewCategory)
        empRecyclerview.adapter = mAdapter

        mAdapter.setOnItemClickListener(object : categoryAdaptor.onItemClickListener {
            override fun onItemClick(position: Int) {

                val intent = Intent(this@AdminViewCategory, AdminViewItems::class.java)
                val category: String = ""
